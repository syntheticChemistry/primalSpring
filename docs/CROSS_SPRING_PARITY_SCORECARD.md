...
**Last updated**: May 22, 2026 (Wave 42 — Neural API full deployment, persistent weights, utilization tracking, team restructuring). biomeOS v3.69, 457 methods, 779 primalSpring tests. NeuralBridge feedback loop operational. All 13 primals at zero debt.
...
|--------|------:|-------------------|-----------------|-----------------|-------------------|--------------|----------------------|----------------|-----------|
| **primalSpring** | 779 | None (validates, doesn't consume) | N/A (is primalSpring) | L8 (absorbed) | **G** 457 methods, sync-tested | **G** 80 deploy + 14 signal graphs | **G** 89 exp crates + 46 scenarios (10 tracks) + Waves 1-42 complete, feedback loop + observatory posture + neural routing surface | **Y** 5 (frozen JSON, not live paper) | **G** bans ring/openssl |
