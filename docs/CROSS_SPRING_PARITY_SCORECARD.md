...
|--------|------:|-------------------|-----------------|-----------------|-------------------|--------------|----------------------|----------------|-----------|
| **primalSpring** | 813 | None (validates, doesn't consume) | N/A (is primalSpring) | L8 (absorbed) | **G** 470+ methods, sync-tested | **G** 82 deploy + 23 signal graphs | **G** 93 exp crates + 57 scenarios (10 tracks) + Waves 1-60 complete, postPrimordial enforced, wateringHole fossilized | **Y** 5 (frozen JSON, not live paper) | **G** bans ring/openssl |
