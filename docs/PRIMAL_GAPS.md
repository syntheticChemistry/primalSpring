...
| toadStool | 23,000+ | **ADOPTED** | FULL | L3 | **CLEAN** — S331: borrowed-deserialization sweep (6 files, zero `from_value(v.clone())` in handlers), test env race fix. S330: +31 tests (9,206 lib), zero clippy warnings. Cross-arch adopted S329, DH-1 resolved S328. 112 methods, zero-copy dispatch, riboCipher CLEAR+MITO. |
