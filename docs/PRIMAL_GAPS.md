...
| toadStool | 23,000+ | **ADOPTED** | FULL | L3 | **CLEAN** — S330: +31 tests (9,206 lib), zero clippy warnings. `decrypt_result` clone elimination (by-value ownership). Unix connection inline tests (12), discovery engine tests (11), execution config tests (8). Cross-arch adopted S329, DH-1 resolved S328. 112 methods, zero-copy dispatch, riboCipher CLEAR+MITO. |
