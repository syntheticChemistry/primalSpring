...
| toadStool | 23,000+ | **ADOPTED** | FULL | L3 | **CLEAN** — S332: Phase 2 Silicon Atheism — `WgpuGpuDiscovery`, `PortableSwapExecutor`, `PortableResourceHandle` (+26 tests, 9,232 lib). S331: borrowed-deser sweep. S330: clippy zero. Cross-arch S329. 112 methods, zero-copy dispatch, riboCipher CLEAR+MITO. |
