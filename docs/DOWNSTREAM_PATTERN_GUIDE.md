...
29 workloads, primal_ipc.sh, 6 CPU parity benchmarks). 458 methods, 49 scenarios
...
Springs already CI-validate against the 458-method registry. Dark Forest checks
...
|-------|------|------------------------|
| 1. Primal Capabilities | 458 methods, 13 primals | Existing: `composition-parity`, `domain-contract-sweep` |
