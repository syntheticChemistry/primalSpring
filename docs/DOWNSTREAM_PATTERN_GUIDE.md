...
29 workloads, primal_ipc.sh, 6 CPU parity benchmarks). 452 methods, 43 scenarios
...
Springs already CI-validate against the 452-method registry. Dark Forest checks
...
calling individual primal methods (452 in the registry), they dispatch
...
|-------|------|------------------------|
| 1. Primal Capabilities | 452 methods, 13 primals | Existing: `composition-parity`, `domain-contract-sweep` |
