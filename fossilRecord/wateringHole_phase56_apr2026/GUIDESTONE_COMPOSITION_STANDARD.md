...
|--------|-------|----------|----------|
| primalSpring v0.9.17 | **4 — NUCLEUS works** | **187/187 live NUCLEUS ALL PASS (13/13 BTSP authenticated, 8 cellular BTSP-enforced)**, 41/41 bare, P3 BLAKE3, seed provenance (Layer 0.5), BTSP default all tiers (Layer 1.5), cellular deployment (Layer 7), genomeBin v5.1 (46 binaries / 6 targets) | Level 5: cross-substrate parity |
...
- **primalSpring guideStone**: **187/187 live NUCLEUS ALL PASS** (Level 4, **13/13 BTSP authenticated**, 8 cellular BTSP-enforced)
