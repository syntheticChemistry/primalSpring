...
| **Tests** | 836+ total (lib + integration + binary + doc) — 2 ignored |
...
| **Mesh** | Live 2-gate (eastGate ↔ strandGate), discovery.peers validated, capability.call HTTP dispatch verified |
