...
| **guideStone** | Level 4 — **157/170 live NUCLEUS** (13/13 BTSP authenticated, 13 failures: Phase 3 interop gap + discovery routing), 41/41 bare, P3 CHECKSUMS (BLAKE3), seed provenance (Layer 0.5), BTSP default everywhere (Layer 1.5), cellular deployment (Layer 7, 8 cells BTSP-enforced), **46 cross-arch binaries (6 targets, Tier 1 39/39)** |
