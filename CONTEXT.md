...
- **Certification engine** — guideStone L0-L8 (69 scenarios, 9-layer
...
| `validation/scenarios` | 69 absorbed experiment scenarios (12 tracks, 3 tiers: Rust/Live/Both) |
...
v0.9.32 Wave 115 (June 17, 2026) — 69 scenarios (12 tracks, 3 tiers),
...
Evolution module: 1,300+ lines (target, pressure, fitness, profile, report, gate).
...
- 490+ method registry (100% exercised), 69 scenarios, 114 deploy graphs
