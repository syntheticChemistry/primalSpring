...
- **Certification engine** — guideStone L0-L8 (67 scenarios, 9-layer
...
| `validation/scenarios` | 67 absorbed experiment scenarios (12 tracks, 3 tiers: Rust/Live/Both) |
...
v0.9.32 Wave 115 (June 17, 2026) — 67 scenarios (12 tracks, 3 tiers),
490+ registered capability methods, 96 experiments (21 tracks), 114 graph TOMLs
(~80 deploy + 34 compositions). 933 tests passing (884 lib + 10 integration +
...
- 490+ method registry (100% exercised), 67 scenarios, 114 deploy graphs
