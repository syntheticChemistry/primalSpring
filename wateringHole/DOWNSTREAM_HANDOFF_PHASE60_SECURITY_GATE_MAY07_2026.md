...
### Registry: 369 Methods Across 80 Domains

The capability registry now tracks 369 methods across 80 domain sections, owned
...
- **369 registered capability methods**
...
# - config/capability_registry.toml (369 methods, auth.* section)
```
