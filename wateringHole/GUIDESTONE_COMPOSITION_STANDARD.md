...
| wetSpring V148 | **4 — NUCLEUS works** | 31/31 live checks (11 skip), cross-atomic pipeline (hash→store→verify), BLAKE3 P3 | barraCuda 6 methods RESOLVED (Sprint 44); Squirrel RESOLVED (PG-30); ~~ToadStool compute.dispatch (PG-31)~~ **RESOLVED** — re-validate for Level 5 |
