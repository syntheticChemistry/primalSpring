...
|--------|-------|----------|----------|
| primalSpring v0.9.17 | **4 — NUCLEUS works** | 161/166 live NUCLEUS (5 FAIL = upstream BTSP gaps), 41/41 bare, P3 BLAKE3, seed provenance (Layer 0.5), BTSP escalation (Layer 1.5), genomeBin v5.1 (46 binaries / 6 targets) | Level 5: cross-substrate parity |
...
- **primalSpring guideStone**: 161/166 live NUCLEUS checks pass (Level 4, 5 expected FAIL — upstream BTSP server gaps)
