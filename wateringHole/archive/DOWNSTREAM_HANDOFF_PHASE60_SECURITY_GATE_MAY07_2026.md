...
The capability registry now tracks 389 methods across 82 domain sections, owned
...
- **389 registered capability methods**
...
# - config/capability_registry.toml (389 methods, auth.* + nautilus.* sections)
```
