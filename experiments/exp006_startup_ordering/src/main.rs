...
//! Exp006: Startup Ordering — validates deploy-graph germination waves.
//!
//! Phases:
//!   1. Capability containment — Tower ⊂ Node ⊂ FullNucleus
//!   2. Topological waves — minimum wave depth per atomic graph
...
fn main() {
    ValidationResult::new("primalSpring Exp006 — Startup Ordering")
        .with_provenance("exp006_startup_ordering", "2026-05-09")
        .run(
